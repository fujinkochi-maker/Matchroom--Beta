      ...
      <section className="container-x -mt-10">
        <div className="relative overflow-hidden border border-border bg-card shadow-card">
          <div className="p-6 md:p-10">
            <p className="text-center text-[10px] font-bold uppercase tracking-[0.2em] text-matchroom-red">
              {mainTitle}
            </p>
            <div className="mt-4 grid grid-cols-[1fr_auto_1fr] items-center gap-4 md:gap-8">
              ...
              <div className="text-center">
                <span className="font-display text-4xl text-matchroom-red md:text-6xl">VS</span>
              </div>
              <div className="text-center">
                <div className="mx-auto w-24 md:w-32">
                  <FighterAvatar
                      ...
                      return (
                        <div key={i} className="flex items-center justify-between py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-display text-sm text-matchroom-red">VS</span>
                            <Link
                              to="/boxers/$username"
